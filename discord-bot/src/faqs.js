...
const FAQS = [
  ...
  },
  {
    ...
    body: [
      ...
      "• **ElvUI / W2UI / GW2 UI / RealUI** — live theme colours",
      "• **All The Things / Can I Mog It** — tracked collections and bag appearances",
  ...
  },
  {
    ...
    body: [
      "Auto follows W2UI, GW2 UI, RealUI, or ElvUI when those addons are loaded. `/ls theme` lists the palettes.",
